...
export function SignUpForm() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-[#FFF8ED] border-2 dark:bg-black z-[10000]">
      ...
      Sign Up with BudgetBuddy to track your expenses, and manage your budget seamlessly.
      </p>

      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <Label className="text-[#1c1f58]" htmlFor="firstname">First name</Label>
            <Input className="" id="firstname" placeholder="Peter" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname" className="text-[#1c1f58]">Last name</Label>
            <Input id="lastname" className="" placeholder="Griffin" type="text" />
          </LabelInputContainer>
        </div>
