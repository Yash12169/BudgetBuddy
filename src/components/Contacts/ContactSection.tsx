...
export default function ContactSection() {
  return (
    <>
      ...
      <section
        id="contact"
        className="min-h-screen pt-36 px-4 md:px-16 bg-cover bg-center bg-no-repeat text-white"
        style={{
          backgroundImage:
            "url('https://t4.ftcdn.net/jpg/11/27/63/07/240_F_1127630724_oU6JuzUT5tdLEwD0MNznJt6oUs8c6fED.jpg')",
        }}
      >
        <div className="bg-black bg-opacity-90 rounded-xl p-8 max-w-5xl mx-auto">
          <h2
            className={`${montserrat.className} text-3xl font-bold mb-12 text-center`}
          >
            Meet Our Team
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="bg-white bg-opacity-10 p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300"
              >
                <div className="flex items-center mb-4">
                  <div className="w-16 h-16 rounded-full bg-green-300 text-white flex items-center justify-center mr-4 text-xl font-bold">
