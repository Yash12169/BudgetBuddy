...
import old from "../../assets/Grandma-bro.png"
import { montserrat } from "@/fonts/fonts";
import { useRouter } from "next/navigation";
const RetirementHoverCard = () => {
  return (
      <TiltCard />
  );
};
...
const TiltCard = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Image src={old} alt="wealth"/>
        <div className="flex justify-center font-semibold text-2xl items-center">
            <p className={`${montserrat} text-neutral-content`}>Retirement</p>
        </div>
      </div>
    </motion.div>
  );
...
export default RetirementHoverCard;